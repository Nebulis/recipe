...
export const Connexion = () => {
  ...
  return user ? (
    <button onClick={logout} style={{ height: "36px" }}>
      <img style={{ borderRadius: "50%", width: "36px", height: "36px" }} src={user.photoURL || ""} alt="user" />
    </button>
  ) : (
    <button onClick={login} style={{ height: "36px" }}>
      <svg
